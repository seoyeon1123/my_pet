      ...
      <div className="xs:w-80 sm:w-80 md:w-96 lg:w-[450px] xl:w-[450px]">
        ...
        <form className="flex flex-col gap-8">
          <div className="flex flex-col gap-2 mb-6">
            ...
            <p className="text-sm text-neutral-500">회원가입 할 때 입력했던 아이디와 이메일을 입력해주세요.</p>
          </div>
        ...
        {isEmailVerified ? (
          <div className="mt-6">
            ...
            <p className="text-sm text-neutral-500">이메일 인증이 완료되었습니다. 새 비밀번호를 설정해주세요.</p>
            <form className="flex flex-col gap-6 mt-4" onSubmit={handlePasswordChange}>
              <Input
                name="newPassword"
                type="password"
                placeholder="새 비밀번호"
          ...
          <EmailVerification username={username} handleEmailVerificationSuccess={handleEmailVerificationSuccess} />
        )}
